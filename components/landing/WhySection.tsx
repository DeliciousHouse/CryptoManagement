...
const benefits = [
  {
    title: 'Scalability',
    description:
      'Easily expand your mining operation by adding containerized units as your needs grow.',
  },
  {
    title: 'Mobility',
    description:
    ...
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
          Why Containerized Bitcoin Mining?
        </h2>
        <p className="text-xl text-gray-400 text-center mb-16 max-w-2xl mx-auto">
          Modern mining operations require flexibility, efficiency, and
          scalability. Containerized solutions deliver all three.
        </p>
